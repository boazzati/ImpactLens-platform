...
function App() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      if (testResponse.ok) {
        ...
        setAnalysisResults({
          ...
          risks: analysis.risks || [
            'Market analysis completed with real AI',
      ...
      // Fallback to JWT-based API if test endpoint fails
      if (!authToken) {
        throw new Error('No authentication token')
      }
      
      console.log('🔐 Using JWT-based API...')
      ...
      console.log('📋 Scenario created, job ID:', jobId)
      ...
      setAnalysisResults({
        ...
        recommendations: [
          ...
          'This is fallback data - backend connection failed'
        ],
        risks: [
